...
void BM_add_multiply_unrolled(benchmark::State &state)
{
    ...
    for (auto _ : state)
    {
        ...
        {
            a1 += p1[i] * p2[i] + p1[i + 1] * p2[i + 1] + p1[i + 2] * p2[i + 2] + p1[i + 3] * p2[i + 3] + p1[i + 4] * p2[i + 4] + p1[i + 5] * p2[i + 5] + p1[i + 6] * p2[i + 6] + p1[i + 7] * p2[i + 7] + p1[i + 8] * p2[i + 8] + p1[i + 9] * p2[i + 9] + p1[i + 10] * p2[i + 10] + p1[i + 11] * p2[i + 11] + p1[i + 12] * p2[i + 12] + p1[i + 13] * p2[i + 13] + p1[i + 14] * p2[i + 14] + p1[i + 15] * p2[i + 15];
        }
        benchmark::DoNotOptimize(a1);
        benchmark::DoNotOptimize(a2);
        benchmark::ClobberMemory();
